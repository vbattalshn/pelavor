export default function Wallet() {
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="1.5"
        d="M6.71 5.528l-1.75 4.18A4.894 4.894 0 002 14.198v-2.93c0-2.84 2.02-5.21 4.71-5.74zM21.519 11.268v2.93c0-2.2-1.46-4.07-3.46-4.67.52-1.3.67-2.32.42-3.17-.02-.09-.05-.18-.09-.26 1.86.96 3.13 2.93 3.13 5.17z"
      ></path>
    </svg>
    )
}